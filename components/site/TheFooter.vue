              ...
              <div class="mb-3">
                <div class="form-check" onselectstart="return false;">
                  ...
                  <label class="form-check-label" for="footer-accept-privacy-policy">
                    {{language[current][21]}} <a href="/terms-of-use" target="_blank" class="text-decoration-none text-warning">пользовательского соглашения</a> и <a href="/privacy-policy" target="_blank" class="text-decoration-none text-warning">политики конфиденциальности</a>
                  </label>
                </div>
              </div>
            </div>
...
export default {
  ...
  data() {
    return {
      ...
      language: [
        ['Пользовательское соглашение','Политика конфеденциальности','Правила ТЦ','Правила размещения объявлений','О нас','Инфраструктура','Введите наименование','Наименование ТОО/ИП','Требуемая площадь помещения','Минимальная','Максимальная','Категория товара или услуги','Введите категорию товара или услуги','Введите контактное лицо','Контактное лицо','Телефон для связи','Введите телефон','Введите БИН/ИИН','Введите email','Введите комментарии','Другие условия для работы/комментарии','Я принимаю условия','Отправить', 'Служба поддержки'],
        ['Пайдаланушылық келісім','Құпиялылық саясаты','СО ережелері','Жарнама беру ережелери','Бiз туралы','Инфрақұрылым','Введите наименование','Наименование ТОО/ИП','Требуемая площадь помещения','Минимальная','Максимальная','Категория товара или услуги','Ввыедите категорию товара или услуги','Введите контактное лицо','Контактное лицо','Телефон для связи','Введите телефон','Введите БИН/ИИН','Введите email','Введите комментарии','Другие условия для работы/комментарии','Я принимаю условия','Отправить', 'Служба поддержки']
      ]
    }
  },
  computed: {
