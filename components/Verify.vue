  ...
  <div class="bg">
    <div class="login-main">
      ...
      <template v-if="!password">
        <div class="login-title" v-if="type === 1">На ваш телефон номер (<b>{{restoreUser.phone}}</b>) был отправлен смс код для подтверждения регистрации</div>
        <div class="login-title" v-else>На вашу эл.почту (<b>{{restoreUser.email}}</b>) был отправлен код для подтверждения регистрации</div>
