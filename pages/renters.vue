...
export default {
  ...
  data () {
    return {
      ...
      language: [
        [
          'Личный кабинет','Главная','Арендаторам','У нас предусмотрены гибкие условия для аренды, индивидуальный подход к каждому арендатору','Заявка на аренду',
          'С нами сотрудничают','Все необходимые условия для размещения вашего бизнеса','Наименование TOO/ИП','Введите наименование','Введите свои данные',
          'БИН/ИИН','Введите БИН/ИИН','Категория товара или услуги','Введите категория товара или услугу','Требуемая площадь помещения',
        ...
        [
          ...
          'Бізбен бірге қызмет жасайды','Сіздің бизнесіңіздің орналасуына барлық керекті шарттар','TOO/ИП атауы','Атын енгізіңіз','Мәліметтеріңізді енгізіңіз',
          'БСН/ЖСН','БСН/ЖСН енгізіңіз','Өнім немесе қызмет санаты','Өнім немесе қызмет санатын енгізіңіз','Қажетті бөлме ауданы',
